...
import DefineRealmModelTestCodeblockDefineModelDartDart from "!!raw-loader!./snippets/define_realm_model_test.codeblock.define-model-dart.dart";
import DefineRealmModelTestCodeblockDefineModelFlutterDart from "!!raw-loader!./snippets/define_realm_model_test.codeblock.define-model-flutter.dart";
import DefineRealmModelTestCodeblockDefineModelDart from "!!raw-loader!./snippets/define_realm_model_test.codeblock.define-model.dart";
import OpenRealmTestCodeblockCloseRealmDart from "!!raw-loader!./snippets/open_realm_test.codeblock.close-realm.dart";
import OpenRealmTestCodeblockOpenRealmDart from "!!raw-loader!./snippets/open_realm_test.codeblock.open-realm.dart";
import QuickStartTestCodeblockCreateRealmObjectDart from "!!raw-loader!./snippets/quick_start_test.codeblock.create-realm-object.dart";
import QuickStartTestCodeblockDeleteManyRealmObjectsDart from "!!raw-loader!./snippets/quick_start_test.codeblock.delete-many-realm-objects.dart";
import QuickStartTestCodeblockDeleteOneRealmObjectDart from "!!raw-loader!./snippets/quick_start_test.codeblock.delete-one-realm-object.dart";
import QuickStartTestCodeblockListenToCollectionRealmObjectsDart from "!!raw-loader!./snippets/quick_start_test.codeblock.listen-to-collection-realm-objects.dart";
import QuickStartTestCodeblockListenToEntireRealmDart from "!!raw-loader!./snippets/quick_start_test.codeblock.listen-to-entire-realm.dart";
import QuickStartTestCodeblockListenToSingleRealmObjectDart from "!!raw-loader!./snippets/quick_start_test.codeblock.listen-to-single-realm-object.dart";
import QuickStartTestCodeblockQueryAllRealmObjectsDart from "!!raw-loader!./snippets/quick_start_test.codeblock.query-all-realm-objects.dart";
import QuickStartTestCodeblockQueryRealmObjectsWithFilterDart from "!!raw-loader!./snippets/quick_start_test.codeblock.query-realm-objects-with-filter.dart";
import QuickStartTestCodeblockQueryRealmObjectsWithSortDart from "!!raw-loader!./snippets/quick_start_test.codeblock.query-realm-objects-with-sort.dart";
import QuickStartTestCodeblockUpdateRealmObjectDart from "!!raw-loader!./snippets/quick_start_test.codeblock.update-realm-object.dart";
...
Delete multiple cars with the `Realm.deleteMany() <realm/Realm/deleteMany.html>` method in a write transaction block.
